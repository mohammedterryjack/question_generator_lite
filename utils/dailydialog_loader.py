...
def load_daily_dialog(path_to_file:str,include_full_context:bool=True) -> List[Tuple[str,str]]:
    """
    ...
    for line_dialogue,line_acts in zip(dialogues,dialogue_acts):
        ...
        if question_in_dialogue:
            ...
            for question_index in question_act_indexes:
                context_start_index = 0 if include_full_context or question_index == 0 else question_index-1
                context = utterances[context_start_index:question_index]
